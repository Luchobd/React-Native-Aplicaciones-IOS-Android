...
export const PullToRefreshScreen = () => {
  ...
  return (
    <ScrollView style={{marginTop: refreshing ? top : 0}}
      refreshControl={
        <RefreshControl
          ...
          progressBackgroundColor="#5856d6" // Colocar un bakground color para que no se vea el loading cuando se hace el refresh
          colors={['red', 'orange', 'yellow']} // Colocar un color para que se vea el loading cuando se hace el refresh. Se puede jugar con varios colores para el loading.
          ...
          titleColor={'white'} // Esto solo aplica en IOS
        />
      }>
